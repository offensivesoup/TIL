...
SECRET_KEY = 'django-insecure-66bj8-9t5@_=s@dhlp(ib%9&91lqh26u6*@p2r*ko%=1h5e_2n'
...
TEMPLATES = [
    {
        ...
        # 해당 하는 위치도 조회할 수 있도록 django에게 알려줘야한다.
        # 그러나 그런 폴더의 경로를 절대 경로로 작성하게 되면,
            # 프로젝트를 실행하는 환경에 따라서... 찾지 못하게 될 수도 있다.
            # C://users//ssafy//desktop//lectures//.....
            # C://users//windows 10//.....
        # 그래서 상대경로를 이용한다.
            # BASE_DIR 이라는 변수에 할당되는 주소값을 사용한다.
