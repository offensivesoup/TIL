...
from .serializers import ArtistSerializer, ArtistListSerializer, ArtistChangeSerializer
...
def artist_detail(request, artist_pk):
    ...
    if request.method == 'GET':
        ...
        serializer = ArtistChangeSerializer(instance = artist, data = request.data, partial = True)
